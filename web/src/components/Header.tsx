...
import * as Dialog from '@radix-ui/react-dialog'; //facilitar o processo de fazer componentes com acessibilidade - já trás vários componentes de forma "simplificada"
  ...
  return(
      <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
        ...
        <Dialog.Root>
          ...
          >
            <Plus size={20} className="text-violet-500 focus:outline-none focus:ring-2 "/>
            Novo Hábito
          </Dialog.Trigger>
