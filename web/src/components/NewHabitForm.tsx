            ...
            <div className='flex flex-col gap-2 mt-3'>
                {availableWeekDays.map((weekDay, index) => {
                    return (
                        ...
                        >
                            <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:border-green-500 transition-colors group-data-[state=checked]:bg-green-500 group-focus:ring-2 group-focus:ring-violet-600 group-focus:ring-offset-2 group-focus:ring-offset-background'>
                                <Checkbox.Indicator>
                                    <Check size={20}/>
                                </Checkbox.Indicator>
                            </div>
